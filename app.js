...
! function(n, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.queue = t() }(this, function() {
    "use strict";

    function n() {}

    function t(t) {
        function r() { if (!c) try { e() } catch (n) { a[w + s - 1] && i(n) } }
        ...
        function f(n) { return function(t, o) { a[n] && (--s, ++w, a[n] = null, null == d && (null != t ? i(t) : (p[n] = o, h ? r() : s || y(d, p)))) } }

        function i(n) {
            var t, r = a.length;
            for (d = n, p = void 0, h = NaN; --r >= 0;)
                if ((t = a[r]) && (a[r] = null, t.abort)) try { t.abort() } catch (n) {}
            s = NaN, y(d, p)
        }
        ...
        var l, c, a = [],
            ...
            d = null,
            y = n;
        return l = { defer: function(t) { if ("function" != typeof t || y !== n) throw new Error; if (null != d) return l; var u = o.call(arguments, 1); return u.push(t), ++h, a.push(u), r(), l }, abort: function() { return null == d && i(new Error("abort")), l }, await: function(t) { if ("function" != typeof t || y !== n) throw new Error; return y = function(n, r) { t.apply(null, [n].concat(r)) }, s || y(d, p), l }, awaitAll: function(t) { if ("function" != typeof t || y !== n) throw new Error; return y = t, s || y(d, p), l } }
    }

    function r(n) { return t(arguments.length ? +n : 1 / 0) }
    var o = [].slice,
        u = {};
...
! function(n, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(n.topojson = n.topojson || {}) }(this, function(n) {
    ...
    function t(n) {
        ...
        var t, r, e = n.scale[0],
            ...
            i = n.translate[0],
            u = n.translate[1];
        return function(n, f) { f || (t = r = 0), n[0] = (t += n[0]) * e + i, n[1] = (r += n[1]) * o + u }
    }
    ...
    function e(n, t) { for (var r, e = n.length, o = e - t; o < --e;) r = n[o], n[o++] = n[e], n[e] = r }
    ...
    function i(n, t) { var r = { type: "Feature", id: t.id, properties: t.properties || {}, geometry: u(n, t) }; return null == t.id && delete r.id, r }
    ...
    function u(n, r) {
        ...
        function i(n) { return n = n.slice(), s(n, 0), n }

        function u(n) { for (var t = [], r = 0, e = n.length; r < e; ++r) o(n[r], t); return t.length < 2 && t.push(t[0].slice()), t }

        function f(n) { for (var t = u(n); t.length < 4;) t.push(t[0].slice()); return t }

        function c(n) { return n.map(f) }

        function a(n) { var t = n.type; return "GeometryCollection" === t ? { type: t, geometries: n.geometries.map(a) } : t in h ? { type: t, coordinates: h[t](n) } : null }
        var s = t(n.transform),
            l = n.arcs,
            h = { Point: function(n) { return i(n.coordinates) }, MultiPoint: function(n) { return n.coordinates.map(i) }, LineString: function(n) { return u(n.arcs) }, MultiLineString: function(n) { return n.arcs.map(u) }, Polygon: function(n) { return c(n.arcs) }, MultiPolygon: function(n) { return n.arcs.map(c) } };
        return a(r)
    }
    ...
    function f(n, t, r) {
        ...
        function u(n) { "GeometryCollection" === n.type ? n.geometries.forEach(u) : n.type in s && (c = n, s[n.type](n.arcs)) }
        var f = [];
        if (arguments.length > 1) {
            var c, a = [],
                s = { LineString: o, MultiLineString: i, Polygon: i, MultiPolygon: function(n) { n.forEach(i) } };
            u(t), a.forEach(arguments.length < 3 ? function(n) { f.push(n[0].i) } : function(n) { r(n[0].g, n[n.length - 1].g) && f.push(n[0].i) })
        } else
    ...
    function a(n) { for (var t, r = -1, e = n.length, o = n[e - 1], i = 0; ++r < e;) t = o, o = n[r], i += t[0] * o[1] - t[1] * o[0]; return i / 2 }
    ...
    function s(n, t) {
        ...
        function e(t) { return Math.abs(a(u(n, { type: "Polygon", arcs: [t] }).coordinates[0])) }
        var o = {},
            i = [],
            f = [];
        return t.forEach(function(n) { "Polygon" === n.type ? r(n.arcs) : "MultiPolygon" === n.type && n.arcs.forEach(r) }), i.forEach(function(n) {
            if (!n._) {
                var t = [],
                    r = [n];
                for (n._ = 1, f.push(t); n = r.pop();) t.push(n), n.forEach(function(n) { n.forEach(function(n) { o[n < 0 ? ~n : n].forEach(function(n) { n._ || (n._ = 1, r.push(n)) }) }) })
            }
        }), i.forEach(function(n) { delete n._ }), {
            type: "MultiPolygon",
            arcs: f.map(function(t) {
                var r, i = [];
                if (t.forEach(function(n) { n.forEach(function(n) { n.forEach(function(n) { o[n < 0 ? ~n : n].length < 2 && i.push(n) }) }) }), i = v(n, i), (r = i.length) > 1)
    ...
    function l(n, t) { return n[1][2] - t[1][2] }
    var h = function() {},
        p = function(n, t) { return "GeometryCollection" === t.type ? { type: "FeatureCollection", features: t.geometries.map(function(t) { return i(n, t) }) } : i(n, t) },
        v = function(n, t) {
            function r(t) {
                var r, e = n.arcs[t < 0 ? ~t : t],
                    o = e[0];
                return n.transform ? (r = [0, 0], e.forEach(function(n) { r[0] += n[0], r[1] += n[1] })) : r = e[e.length - 1], t < 0 ? [r, o] : [o, r]
            }

            function e(n, t) {
                for (var r in n) {
                    var e = n[r];
                    delete t[e.start], delete e.start, delete e.end, e.forEach(function(n) { o[n < 0 ? ~n : n] = 1 }), f.push(e)
                }
            }
            var o = {},
                i = {},
            ...
            }), e(u, i), e(i, u), t.forEach(function(n) { o[n < 0 ? ~n : n] || f.push([n]) }), f
        },
        g = function(n) { return u(n, f.apply(this, arguments)) },
        d = function(n) { return u(n, s.apply(this, arguments)) },
        y = function(n) {
            function t(n, t) {
        ...
        m = function() {
            ...
            var r = {},
                e = [],
                o = 0;
            return r.push = function(t) { return n(e[t._ = o] = t, o++), o }, r.pop = function() { if (!(o <= 0)) { var n, r = e[0]; return --o > 0 && (n = e[o], t(e[n._ = 0] = n, 0)), r } }, r.remove = function(r) { var i, u = r._; if (e[u] === r) return u !== --o && (i = e[o], (l(i, r) < 0 ? n : t)(e[i._ = u] = i, u)), u }, r
        },
        E = function(n, e) {
            function o(n) { f.remove(n), n[1][2] = e(n), f.push(n) }
            var i = t(n.transform),
                u = r(n.transform),
                f = m();
...
(function() {
    ...
    function app() {
        ...
        var legend_labels = ["Underrepresentation", "Overrepresentation", "Data Not Available"];
        var color = d3.scale.threshold()
            .domain(color_domain)
            .range(["#adfcad", "#ff1300", "#f7e783", "#000000"]);
        var div = d3.select(".representation-interactive").append("div")
            .attr("class", "tooltip")
            .style("opacity", 0);
        var svg = d3.select(".representation-interactive").append("svg")
        ...
        //Reading map file and data ///Replace with permalinks
        queue()
            .defer(d3.json, "assets/india_pc_2014.json")
            .defer(d3.json, "assets/Admin2_Topo.json")
            .defer(d3.csv, "assets/representation.csv")
            .await(ready);
        //Start of Choropleth drawing
        function ready(error, map, map1, data) {

            document.getElementById("loader").style.display = "none";

            var representation = {};
            data.forEach(function(d) {
                representation[d.ST_CODE + d.PC_CODE] = +d.representation;
            });
            ...
            for (var i = 0; i < data.length; i++) {
                states[data[i].ST_CODE + data[i].PC_CODE] = data[i].StateName;
                constituencies[data[i].ST_CODE + data[i].PC_CODE] = data[i].pc_name_n;
                totalElectors[data[i].ST_CODE + data[i].PC_CODE] = data[i].t_electors;
            }
            ...
            svg.append("g")
                .attr("class", "region")
                .selectAll("path")
                .data(topojson.feature(map, map.objects.india_pc_2014).features)
                .enter().append("path")
                .attr("d", path)
                .style("fill", function(d) {
                    if (d.properties.ST_CODE + d.properties.PC_CODE == -1) {
                        return "black";
                    }
                    return color(representation[d.properties.ST_CODE + d.properties.PC_CODE]);
                })
                .style("opacity", 0.8)
                //Adding mouseevents
                .on("mouseover", function(d) {
                    ...
                    div.transition().duration(300)
                        .style("opacity", 1)
                    if (d.properties.ST_CODE + d.properties.PC_CODE == -1) {
                        div.html("Constituency: Data Not Available" + "<br>" + "State: Data Not Available" + "<br>" + "Total Electors: Data Not Available")
                        ...
                        if (representation[d.properties.ST_CODE + d.properties.PC_CODE] == 1) {
                            div.html("Constituency " + constituencies[d.properties.ST_CODE + d.properties.PC_CODE] + "<br>" + "State: " + states[d.properties.ST_CODE + d.properties.PC_CODE] + "<br>" + "Total Electors: " + d3.format(",")(totalElectors[d.properties.ST_CODE + d.properties.PC_CODE]))
                                .style("display", "block")
                                .style("color", "#000000")
                                .style("background", color(representation[d.properties.ST_CODE + d.properties.PC_CODE]))
                                .style("opacity", 0.2);
                        } else {
                            div.html("Constituency " + constituencies[d.properties.ST_CODE + d.properties.PC_CODE] + "<br>" + "State: " + states[d.properties.ST_CODE + d.properties.PC_CODE] + "<br>" + "Total Electors: " + d3.format(",")(totalElectors[d.properties.ST_CODE + d.properties.PC_CODE]))
                                .style("display", "block")
            ...
            svg.append("g")
                .attr("class", "region")
                .selectAll("path")
                .data(topojson.feature(map1, map1.objects.Admin2).features)
                .enter().append("path")
                .attr("d", path)
                .style("opacity", 1)
                .style("stroke", "#a81f10")
